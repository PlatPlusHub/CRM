...
-- Neither user column is set at creation: SPEC-140 makes assignment an act with a timeline, and
-- SPEC-151 constrains owner_user_id equal to assigned_user_id, so a lead cannot be born owned either.
...
update public.leads set assigned_user_id = '21000000-0000-0000-0000-000000000011',
                        owner_user_id    = '21000000-0000-0000-0000-000000000011'
 where id = '21000000-0000-0000-0000-0000000000e1';
update public.leads set assigned_user_id = '21000000-0000-0000-0000-000000000014',
                        owner_user_id    = '21000000-0000-0000-0000-000000000014'
 where id = '21000000-0000-0000-0000-0000000000e2';
