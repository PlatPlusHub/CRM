...
begin
    ...
    -- 618 -> 621: USR-1 (`20260920120000`) gave public.users the emitter it never had, registering
    -- user_deactivated, user_reactivated and user_identity_bound at sort_order 932-934. All three
