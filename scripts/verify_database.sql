...
-- Expected values track the frozen baseline: 72 public base tables, 69 catalog types, 588 catalog
...
begin
    ...
    if n <> 588 then raise exception 'CHECK 6b FAILED: expected 588 catalog_values, found %', n; end if;
    ...
    raise notice 'ALL CHECKS PASSED (72 tables, RLS + policies, resolver + read-scope model, 69/588 catalog, FK standard, updated_at triggers, append-only audit, grant/schema-usage completeness)';
end
$$;
