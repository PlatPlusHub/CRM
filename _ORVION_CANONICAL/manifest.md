...
2. **Plan gating enforcement** (PLAN-1) — the matrix is seeded; nothing reads it. Canon 35 §8 says the gate's location is decided at implementation.
