...
Live state: Last fully verified 2026-09-20. **repository, local stack and Primary `vrvtsxexkiiiivlkdxzp` all at 219 migrations** (latest `20260920120000`), ledger `dd2427080e9cfb5e8d1d162bf818360f`, full-function-surface hash `f791acdba3e91462b1625ab8a723db4d` (298 functions) and structural-surface hash `e17675f70c73be8953b6f057a068a9ff` (3,624 objects, Primary's) — **nine of ten structural surfaces identical**; the tenth differs only in platform-managed `service_role` grants (PAR-5). Re-read live from Primary 2026-09-20; **parity PROVEN, Primary values read FROM Primary** (GUARD-1). **77 tables**; 71/621 catalog; **8 reporting views**; **79 client RPCs**. Suite **118 files / 1958 assertions** (Pass A = Pass B) plus **449 end-to-end HTTP assertions** across six scripts, last passed 2026-09-20.
...
Active Change Request: changes/SPEC-203-membership-authority-and-audit.md
...
Last Completed: **SPEC-203 membership authority and audit on `public.users`, Complete (2026-09-20).** Batch 6 slice 12. The only canon-34 identity-and-access surface with no emitter, and its RLS charged `has_permission` where the RPC charged `authorize`: at `aal1` the RPC refused `42501` while direct DML created, deactivated and re-bound memberships silently. `20260920120000` adds a BEFORE guard and an AFTER emitter, leaving one producer. 118 files / 1958 assertions.
