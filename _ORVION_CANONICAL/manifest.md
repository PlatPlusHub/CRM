...
Active Change Request: changes/SPEC-211-manifest-headroom-and-master-state.md
...
Last Completed: **`CTRL-2` closed — Pre-Approval evidence applicability is derived PER PREDICATE and verification write closure is refused at Approval, certified by SPEC-210 (2026-09-20).**
