...
Active Change Request: changes/SPEC-213-conversion-provenance-is-platform-written.md
...
Last Completed: **`CTRL-1` closed — terminal-contract immutability activates on a declared boundary resolved by Git ancestry, not on a diagnostic literal, with the original activation boundary preserved; certified by SPEC-212 (2026-09-21).**
