...
Active Change Request: `changes/SPEC-180-certification-target-is-the-upstream.md`
...
Last Completed: **SPEC-179 completion-owned generated state, Complete (2026-09-14).** The certification fingerprint skipped the two files completion rewrites but not the generated `ai-map.json` mirror, so any contract scoping it could never complete. Exactly four completion-owned values are now excluded; the file stays fingerprinted. Suite 155 -> 158.
