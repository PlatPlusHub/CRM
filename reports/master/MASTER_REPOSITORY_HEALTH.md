...
Last measured: 2026-08-10 (SPEC-120 production deployment re-verified: remote migrations match local through `202607049900`; repository worktree and GitHub `main` match at `66f767c`; smoke contract refreshed to 72 tables, 67 catalog types, 569 catalog values). Values marked ⚙ are computable today (grep/script); values marked 👁 require the link-checker/governance-lint tooling to be exact (currently best-effort).
