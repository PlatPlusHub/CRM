...
| Docs-7 | `ai-map.json` stays fresh vs. manifest — current phase, `Last Completed`, **and (2026-08-17) `live_state.next_capability` compared by value** | Check 7 | `repository-consistency.yml` |
